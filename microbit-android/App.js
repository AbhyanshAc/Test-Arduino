...
const styles = StyleSheet.create({
  ...
  statusInfo: { flex: 1 },
  statusLabel: { fontSize: 16, fontWeight: '700', color: '#e8eaed', letterSpacing: 0.5 },
  statusDevice: { fontSize: 12, color: '#6b7280', marginTop: 3, fontWeight: '500' },
  disconnectBtn: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  disconnectBtnText: { color: '#EF4444', fontSize: 18, fontWeight: '700' },
  ...
  tabText: { fontSize: 14, fontWeight: '600', color: '#6b7280', letterSpacing: 0.5 },
  ...
  deviceInfo: { flex: 1 },
  deviceName: { fontSize: 16, fontWeight: '700', color: '#e8eaed', letterSpacing: 0.3 },
  deviceAddr: { fontSize: 11, color: '#6b7280', marginTop: 3, fontFamily: Platform.OS === 'ios' ? 'Menlo' : 'monospace', fontWeight: '500' },
  deviceRssi: { fontSize: 13, color: '#6366f1', fontWeight: '700', letterSpacing: 0.5 },
